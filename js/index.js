...
then(function (data) {
  ...
  function (parking) {
    ...
    gps.innerHTML = '<a class="button is-rounded" href="https://www.google.fr/maps/search/' +
    parking.fields.coords + '">carte</a> <a class="button is-rounded" href="https://www.google.fr/maps/search/' + parking.fields.coords + '">y aller</a>';
